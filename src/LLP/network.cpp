...
namespace LLP
{
    ...
    std::string CNetAddr::ToStringIP() const
    {
        if (IsIPv4())
        {
            return std::to_string(GetByte(3)) + "." +
                   std::to_string(GetByte(2)) + "." +
                   std::to_string(GetByte(1)) + "." +
                   std::to_string(GetByte(0));
        }
        else
        {
            return std::to_string(GetByte(15) << 8 | GetByte(14)) + ":" +
                   std::to_string(GetByte(13) << 8 | GetByte(12)) + ":" +
                   std::to_string(GetByte(11) << 8 | GetByte(10)) + ":" +
                   std::to_string(GetByte(9) << 8 | GetByte(8)) + ":" +
                   std::to_string(GetByte(7) << 8 | GetByte(6)) + ":" +
                   std::to_string(GetByte(5) << 8 | GetByte(4)) + ":" +
                   std::to_string(GetByte(3) << 8 | GetByte(2)) + ":" +
                   std::to_string(GetByte(1) << 8 | GetByte(0));
        }
    }
