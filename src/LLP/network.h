...
namespace LLP
{
    ...
    inline uint16_t GetCorePort(const bool testnet = false){ return testnet ? TESTNET_CORE_LLP_PORT : MAINNET_CORE_LLP_PORT; }


    /* Get the Main Mining LLP Port for Nexus. */
    inline uint16_t GetMiningPort(const bool testnet = false){ return testnet ? TESTNET_MINING_LLP_PORT : MAINNET_MINING_LLP_PORT; }


    /* Get the Main Message LLP Port for Nexus. */
    inline uint16_t GetDefaultPort(const bool testnet = false){ return testnet ? TESTNET_PORT : MAINNET_PORT; }
